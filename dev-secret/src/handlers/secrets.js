...
module.exports.get = async (event, context) => { // recebe a lista de que está participando
    ...
    const { id: externalId } =  event.pathParameters // pegar o id dos parametros
